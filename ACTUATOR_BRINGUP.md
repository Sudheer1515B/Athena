...
# Latest requested signal setting — 2026-09-26

The user identified the connected motor signal as pin 33 and requested 1000 µs. Interpreting this as **bench GPIO33 = OUT3**, the controller sent only `SET 3 1000` over Wi-Fi to `WDR_REFERENCE` at `10.178.45.105:3333`. The bench reported `STOPPED`, 1200 stored frames, and widths `1000,1500,1500,1000` afterward. OUT1/OUT2 remain 1500 µs; OUT0 was already 1000 µs. No STOP, START, upload, counter reset, or firmware change was sent. This confirms the bench's reported signal setting, not physical motor idle or ESC disarming. Receiver GPIO33 is a different pin: it measures bench OUT1.
